...
export const Sidebar: React.FC<SidebarProps> = ({ currentLessonId, onSelectLesson, isOpen, onCloseMobile }) => {
  return (
    <aside className={`
    ...
    `}>
      <div className="h-full flex flex-col">
        <div className="p-4 border-b border-slate-200 dark:border-slate-800 flex items-center gap-2">
          ...
          <span className="font-bold text-xl tracking-tight text-slate-900 dark:text-white">AlgoViet</span>
        </div>
                  ...
                  return (
                    <li key={lesson.id}>
                      <button
                        ...
                        `}
                      >
                        {lesson.exercise ? <Code size={16} /> : <BookOpen size={16} />}
